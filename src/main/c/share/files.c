...
JNIEXPORT jlong JNICALL Java_com_hivemq_tk_Files_mmap0
...
JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_munmap0
...
JNIEXPORT jbyte JNICALL Java_com_hivemq_tk_Files_readNonNegativeByte
        (JNIEnv *e, jclass cl,
         jint fd,
         jlong offset) {
    jbyte result;
...
JNIEXPORT jshort JNICALL Java_com_hivemq_tk_Files_readNonNegativeShort
        (JNIEnv *e, jclass cl,
         jint fd,
         jlong offset) {
    jshort result;
...
JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_readNonNegativeInt
...
JNIEXPORT jlong JNICALL Java_com_hivemq_tk_Files_readIntAsUnsignedLong
        (JNIEnv *e, jclass cl, jint fd, jlong offset) {
    uint32_t result;
    ssize_t readLen = pread((int) fd, (void *) &result, sizeof(jint), (off_t) offset);
...
JNIEXPORT jlong JNICALL Java_com_hivemq_tk_Files_readNonNegativeLong
        (JNIEnv *e, jclass cl, jint fd, jlong offset) {
    jlong result;
    ssize_t readLen;
...
JNIEXPORT jboolean JNICALL Java_com_hivemq_tk_Files_isDir
        (JNIEnv *e, jclass cl, jlong pchar) {
...
JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_softLink
        (JNIEnv *e, jclass cl, jlong pcharSrc, jlong pcharSoftLink) {
    return symlink((const char *) pcharSrc, (const char *) pcharSoftLink);
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_unlink
        (JNIEnv *e, jclass cl, jlong pcharSoftLink) {
    return unlink((const char *) pcharSoftLink);
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_mkdir
...
JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_msync(JNIEnv *e, jclass cl, jlong addr, jlong len, jboolean async) {
    return msync((void *) addr, len, async ? MS_ASYNC : MS_SYNC);
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_fsync(JNIEnv *e, jclass cl, jint fd) {
    return fsync((int) fd);
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_sync(JNIEnv *e, jclass cl) {
    sync();
    return 0;
}
...
JNIEXPORT jlong JNICALL Java_com_hivemq_tk_Files_getPageSize
        (JNIEnv *e, jclass cl) {
    return sysconf(_SC_PAGESIZE);
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_findNext
...
JNIEXPORT void JNICALL Java_com_hivemq_tk_Files_findClose
        (JNIEnv *e, jclass cl, jlong findPtr) {
    FIND *find = (FIND *) findPtr;
    closedir(find->dir);
    free(find);
...
JNIEXPORT jlong JNICALL Java_com_hivemq_tk_Files_findName
        (JNIEnv *e, jclass cl, jlong findPtr) {
    return (jlong) ((FIND *) findPtr)->entry->d_name;
}

JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_findType
        (JNIEnv *e, jclass cl, jlong findPtr) {
...
JNIEXPORT jint JNICALL Java_com_hivemq_tk_Files_openCleanRW
    ...
    jlong fileSize = Java_com_hivemq_tk_Files_length(e, cl, fd);
    if (fileSize > 0) {
        ssize_t res;
        ...
        if (res == 0) {
            ...
            if (ftruncate(fd, 0) == 0) {
                ...
                if (Java_com_hivemq_tk_Files_allocate(e, cl, fd, size) == JNI_TRUE) {
            ...
            if (fileSize >= size || Java_com_hivemq_tk_Files_allocate(e, cl, fd, size) == JNI_TRUE) {
                // put a shared lock
                if (flock((int) fd, LOCK_SH) == 0) {
                    // success
                    return fd;
        ...
        if (Java_com_hivemq_tk_Files_allocate(e, cl, fd, size) == JNI_TRUE && flock((int) fd, LOCK_SH) == 0) {
            // success
            return fd;
        }
    }
