...
import com.hivemq.config.entity.ClientWriteBufferProperties;
...
public class HiveMQNettyBootstrap {
    ...
    public @NotNull ListenableFuture<List<ListenerStartupInformation>> bootstrapServer() {
        ...
        final int shutdownTimeout = InternalConfig.EVENT_LOOP_GROUP_SHUTDOWN_TIMEOUT_SEC;
        final int channelsShutdownTimeout = InternalConfig.CONNECTION_PERSISTENCE_SHUTDOWN_TIMEOUT_SEC;
    ...
    private void setAdvancedOptions(final @NotNull ServerBootstrap b) {
        ...
        final int sendBufferSize = InternalConfig.LISTENER_SOCKET_SEND_BUFFER_SIZE_BYTES;
        final int receiveBufferSize = InternalConfig.LISTENER_SOCKET_RECEIVE_BUFFER_SIZE_BYTES;
        ...
        final int writeBufferHigh = InternalConfig.LISTENER_CLIENT_WRITE_BUFFER_HIGH_THRESHOLD_BYTES;
        final int writeBufferLow = InternalConfig.LISTENER_CLIENT_WRITE_BUFFER_LOW_THRESHOLD_BYTES;
