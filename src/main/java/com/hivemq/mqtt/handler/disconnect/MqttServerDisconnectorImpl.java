...
public class MqttServerDisconnectorImpl implements MqttServerDisconnector {
    ...
    public MqttServerDisconnectorImpl(final @NotNull EventLog eventLog) {
        ...
        disconnectWithReasonCode = InternalConfig.DISCONNECT_WITH_REASON_CODE_ENABLED.get();
        disconnectWithReasonString = InternalConfig.DISCONNECT_WITH_REASON_STRING_ENABLED.get();
    }
