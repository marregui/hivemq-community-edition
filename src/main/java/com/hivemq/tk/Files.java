...
public class Files {
    ...
    public static long mremap(
        ...
        if (newSize < 1) {
            throw CairoException.critical(0)
                    .put("could not remap file, invalid newSize [previousSize=")
                    .put(previousSize)
                    .put(", newSize=")
                    .put(newSize)
                    .put(", offset=")
     ...
     * The function can operate in two modes, eager and haltOnFail. In haltOnFail mode function fails fast, providing
     * precise
     ...
     * @param haltOnFail when true removing directory will halt on first failed attempt to remove directory contents.
     *                   When
     *                   false, the function will remove as many files and subdirectories as possible. That might be
     *                   useful
