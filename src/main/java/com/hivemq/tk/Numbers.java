...
import com.hivemq.tk.time.Dates;import com.hivemq.tk.time.Timestamps;import java.util.Arrays;
...
public final class Numbers {
    ...
    private final static ThreadLocal<char[]> tlDoubleDigitsBuffer = ThreadLocal.withInitial(() -> new char[21]);
    ...
    public static void appendHex(final CharSink<?> sink, final int value) {
        int i = value;
        if (i < 0) {
     ...
     */
    public static void appendHexPadded(final CharSink<?> sink, final long value, final int padToBytes) {
        ...
        final int leadingZeroBits = Long.numberOfLeadingZeros(value);
        final int padToBits = padToBytes << 3;
        final int bitsToPad = padToBits - (Long.SIZE - leadingZeroBits);
        final int bytesToPad = (bitsToPad >> 3);
        ...
        final int bit = 64 - leadingZeroBits;
    ...
    public static void appendLong256(final long a, final long b, final long c, final long d, final CharSink<?> sink) {
    ...
    public static void appendLong256FromUnsafe(final long address, final CharSink<?> sink) {
    ...
    public static void appendUuid(final long lo, final long hi, final CharSink<?> sink) {
    ...
    public static int bswap(final int value) {
        return ((value >> 24) & 0xff) | ((value << 8) & 0xff0000) | ((value >> 8) & 0xff00) | ((value << 24) & 0xff000000);
    }

    public static short bswap(final short value) {
    ...
    public static long ceilPow2(final long value) {
        long i = value;
        if ((i != 0) && (i & (i - 1)) > 0) {
            i |= (i >>> 1);
            i |= (i >>> 2);
    ...
    public static short decodeHighShort(final int val) {
        return (short) (val >> 16);
    }
    ...
    public static short decodeLowShort(final int val) {
    ...
    public static int encodeLowHighShorts(final short low, final short high) {
        return ((Short.toUnsignedInt(high)) << 16) | Short.toUnsignedInt(low);
    }

    public static boolean equals(final float l, final float r) {
        return (isNull(l) && isNull(r)) || Math.abs(l - r) <= DOUBLE_TOLERANCE;
    }

    public static boolean equals(final double l, final double r) {
        return (isNull(l) && isNull(r)) || Math.abs(l - r) <= DOUBLE_TOLERANCE;
    }

    // returns lo | hi network address in a single long
    public static long getBroadcastAddress(final CharSequence sequence) throws NumericException {
        final long subnetAndNetmask = Numbers.getIPv4Subnet(sequence);
        final int subnet = (int) (subnetAndNetmask >> 32);
        final int netmask = (int) (subnetAndNetmask);
        // sets all remaining bits to the right of the subnet
        final int broadcastAddress = subnet | ~(0xffffffff << (32 - getNetmaskLength(netmask)));

        return pack(subnet & netmask, broadcastAddress);
    }

    // returns network mask, e.g. 255.0.0.0 == /8 or Numbers.BAD_NETMASK on error
    public static int getIPv4Netmask(final CharSequence sequence) {
        final int mid = Chars.indexOf(sequence, 0, '/') + 1;
        ...
        try {
            final int bits = parseInt0(sequence, mid, sequence.length());
    ...
    public static long getIPv4Subnet(final CharSequence sequence) throws NumericException {
        final int netmask = getIPv4Netmask(sequence);
        if (netmask == BAD_NETMASK) {
            throw NumericException.INSTANCE;
        }

        final int mid = Chars.indexOf(sequence, 0, '/');
        ...
        try {
            ...
            final int ipv4 = parseIPv4_0(sequence, 0, mid);
    ...
    public static int getNetmaskLength(final int netmask) {
        return 32 - Integer.numberOfTrailingZeros(netmask);
    }

    public static int hexDigitNumber(final long value) {
        final int mag = 64 - Long.numberOfLeadingZeros(value|1);
        final int v = (mag + 3) / 4;
        return v + (v & 1); // round up to even number of digits 0x123 -> 0x0123
    }

    public static int hexDigitsLong256(final long a, final long b, final long c, final long d) {
    ...
    public static int hexToDecimal(final int c) throws NumericException {
        if (c > 127) {
            throw NumericException.INSTANCE;
        }
        final int r = hexNumbers[c];
        if (r == -1) {
            throw NumericException.INSTANCE;
        }
        return r;
    ...
    public static void intToIPv4Sink(final CharSink<?> sink, final int value) {
    ...
    public static long interleaveBits(final long x, final long y) {
        return spreadBits(x) | (spreadBits(y) << 1);
    }

    // leaves first 32 bits unset - remaining 32 bits are the ip address
    public static long ipv4ToLong(final int value) {
        return value & (-1L >>> 32);
    }

    public static boolean isDecimal(final CharSequence value, final int start) {
    ...
    public static boolean isNull(final float value) {
    ...
    public static boolean lessThan(final long a, final long b, final boolean negated) {
        final boolean eq = a == b;
        return (eq || (a != LONG_NULL && b != LONG_NULL)) && (negated ? (eq || a > b) : (!eq && a < b));
    }

    public static boolean lessThan(final int a, final int b, final boolean negated) {
        final boolean eq = a == b;
        return (eq || (a != INT_NULL && b != INT_NULL)) && (negated ? (eq || a > b) : (!eq && a < b));
    }

    public static boolean lessThanIPv4(final int a, final int b, final boolean negated) {
        final long a1 = ipv4ToLong(a);
        final long b1 = ipv4ToLong(b);
    ...
    public static int msb(final long value) {
    ...
    public static boolean notDigit(final byte b) {
        return b < '0' || b > '9';
    }

    public static double parseDouble(final CharSequence sequence) throws NumericException {
        return FastDoubleParser.parseDouble(sequence, true);
    }

    public static double parseDoubleQuiet(final CharSequence sequence) {
        if (sequence == null) {
            return Double.NaN;
        }
        try {
    ...
    public static int parseHexInt(final CharSequence sequence) throws NumericException {
        return parseHexInt(sequence, 0, sequence.length());
    }

    public static int parseHexInt(final CharSequence sequence, final int lo, final int hi) throws NumericException {
        if (hi == 0) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseHexLong(final CharSequence sequence) throws NumericException {
        return parseHexLong(sequence, 0, sequence.length());
    }

    public static long parseHexLong(final CharSequence sequence, final int lo, final int hi) throws NumericException {
        if (hi == 0) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseHexLong(final Utf8Sequence sequence, final int lo, final int hi) throws NumericException {
        if (hi == 0) {
            throw NumericException.INSTANCE;
        }
    ...
    public static int parseIPv4(final CharSequence sequence) throws NumericException {
    ...
    public static int parseIPv4(final Utf8Sequence sequence) throws NumericException {
    ...
    public static int parseIPv4Nl(final Utf8Sequence sequence) throws NumericException {
    ...
    public static int parseIPv4Quiet(final CharSequence sequence) {
        try {
    ...
    public static int parseIPv4UDP(final CharSequence sequence) throws NumericException {
    ...
    public static int parseIPv4_0(final CharSequence sequence, final int p, final int lim) throws NumericException {
        if (lim == 0) {
            throw NumericException.INSTANCE;
        }
    ...
    public static int parseInt(final Utf8Sequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static int parseInt(final Utf8Sequence sequence, final int p, final int lim) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseInt000Greedy(final CharSequence sequence, final int p, final int lim) throws NumericException {
        if (lim == p) {
            throw NumericException.INSTANCE;
        }
    ...
    public static int parseIntQuiet(final CharSequence sequence) {
        try {
    ...
    public static int parseIntSize(final CharSequence sequence) throws NumericException {
    ...
    public static long parseLong(final CharSequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseLong(final Utf8Sequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseLong(final Utf8Sequence sequence, final int p, final int lim) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseLong000000Greedy(final CharSequence sequence, final int p, final int lim) throws NumericException {
        if (lim == p) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseLongDuration(final CharSequence sequence) throws NumericException {
        final int lim = sequence.length();
        if (lim == 0) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseLongQuiet(final CharSequence sequence) {
        if (sequence == null) {
    ...
    public static long parseLongSize(final CharSequence sequence) throws NumericException {
        final int lim = sequence.length();
    ...
    public static long parseMicros(final CharSequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
        final int lim = sequence.length();
    ...
    public static long parseMillis(final CharSequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
        final int lim = sequence.length();
    ...
    public static long parseNanos(final CharSequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
        final int lim = sequence.length();
    ...
    public static short parseShort(final Utf8Sequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static short parseShort(final CharSequence sequence) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static short parseShort(final CharSequence sequence, final int p, final int lim) throws NumericException {
        if (sequence == null) {
            throw NumericException.INSTANCE;
        }
    ...
    public static long parseSubnet(final CharSequence sequence) throws NumericException {
        final int delim = Chars.indexOf(sequence, 0, '/');
        if (delim == -1) {
            throw NumericException.INSTANCE;
        }

        final int netmaskBits = parseInt0(sequence, delim + 1, sequence.length());
    ...
    public static int parseSubnet0(final CharSequence sequence, final int p, final int lim, final int netmaskLength) throws NumericException {
        int hi;
        int lo = p;
        int num;
        int ipv4 = 0;
        ...
        final int bits = 32 - netmaskLength;
        int i = 1;
    ...
    public static int reverseBits(final int i) {
        return i<<24 | i>>8 & 0xff00 | i<<8 & 0xff0000 | i>>>24;
    }

    public static double roundDown(final double value, final int scale) throws NumericException {
    ...
    public static double roundDownNegScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
        return Double.longBitsToDouble(Double.doubleToRawLongBits(roundDown00NegScale(absValue, scale)) | signMask);
    }

    public static double roundDownPosScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static double roundHalfDown(final double value, final int scale) throws NumericException {
    ...
    public static double roundHalfEven(final double value, final int scale) throws NumericException {
        if (scale + 2 < pow10max && scale > -pow10max) {
    ...
    public static double roundHalfEven0NegScale(final double value, final int scale) {
        final long val = (long) (value * pow10dNeg[scale] * pow10[2] + TOLERANCE);
        final long remainder = val % 100;
    ...
    public static double roundHalfEven0PosScale(final double value, final int scale) {
        final long val = (long) (value * pow10[scale] * pow10[2] + TOLERANCE);
        final long remainder = val % 100;
    ...
    public static double roundHalfEvenNegScale(final double value, final int scale) {
        return value > 0 ? roundHalfEven0NegScale(value, scale) : -roundHalfEven0NegScale(-value, scale);
    }

    public static double roundHalfEvenPosScale(final double value, final int scale) {
        return value > 0 ? roundHalfEven0PosScale(value, scale) : -roundHalfEven0PosScale(-value, scale);
    }

    public static double roundHalfUp(final double value, final int scale) throws NumericException {
        if (scale + 2 < pow10max && scale > -pow10max) {
            final long valueBits = Double.doubleToRawLongBits(value);
            final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
            final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static double roundHalfUpNegScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static double roundHalfUpPosScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static double roundUp(final double value, final int scale) throws NumericException {
        if (scale < pow10max && scale > -pow10max) {
    ...
    public static double roundUpNegScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static double roundUpPosScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    public static int sinkSizeIPv4(final int value) {
    ...
    public static String toHexStrPadded(final long value) {
    ...
    private static void appendLong256Four(final long a, final long b, final long c, final long d, final CharSink<?> sink) {
        appendLong256Three(b, c, d, sink);
        appendHex(sink, a, true);
    }

    private static void appendLong256Three(final long a, final long b, final long c, final CharSink<?> sink) {
        appendLong256Two(b, c, sink);
        appendHex(sink, a, true);
    }

    private static void appendLong256Two(final long a, final long b, final CharSink<?> sink) {
    ...
    private static int estimateDecExpDouble(final long fractBits, final int binExp) {
        final double d2 = Double.longBitsToDouble(EXP_ONE | fractBits & SIGNIF_BIT_MASK);
        final double d = (d2 - 1.5D) * 0.289529654D + 0.176091259D + (double) binExp * 0.301029995663981D;
        final long dBits = Double.doubleToRawLongBits(d);
        final int exponent = (int) ((dBits & EXP_BIT_MASK) >> EXP_SHIFT) - EXP_BIAS;
    ...
    private static short parseShort0(final CharSequence sequence, final int p, final int lim) throws NumericException {
        if (lim == p) {
            throw NumericException.INSTANCE;
        }
        ...
        for (; i < lim; i++) {
            ...
            final short r = (short) ((val << 3) + (val << 1) - (c - '0'));
            if (r > val) {
                throw NumericException.INSTANCE;
            }
            val = r;
    ...
    private static double roundDown0(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    private static double roundDown00(final double value, final int scale) {
        return scale < 0 ? roundDown00NegScale(value, -scale) : roundDown00PosScale(value, scale);
    }

    private static double roundDown00NegScale(final double value, final int scale) {
        final long powten = pow10[scale];
        final double powtenNeg = pow10dNeg[scale];
        return ((double) (long) ((value + TOLERANCE) * powtenNeg)) * powten;
    }

    private static double roundDown00PosScale(final double value, final int scale) {
        final long powten = pow10[scale];
        final double powtenNeg = pow10dNeg[scale];
        return ((double) (long) ((value + TOLERANCE) * powten)) * powtenNeg;
    }

    private static double roundDown0NegScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
        return Double.longBitsToDouble(Double.doubleToRawLongBits(roundDown00NegScale(absValue, scale)) | signMask);
    ...
    private static double roundHalfDown0(final double value, final int scale) {
        final long val = (long) (value * pow10[scale + 2] + TOLERANCE);
        return val % 100 > 50 ? roundUp0(value, scale) : roundDown0(value, scale);
    }

    private static double roundHalfEven0(final double value, final int scale) {
        return scale > 0 ? roundHalfEven0PosScale(value, scale) : roundHalfEven0NegScale(value, -scale);
    }

    private static double roundHalfUp0(final double value, final int scale) {
        return scale > 0 ? roundHalfUp0PosScale(value, scale) : roundHalfUp0NegScale(value, -scale);
    }

    private static double roundHalfUp0NegScale(final double value, final int scale) {
        final long val = (long) (value * pow10dNeg[scale] * pow10[2] + TOLERANCE);
        return val % 100 < 50 ? roundDown0NegScale(value, scale) : roundUp0NegScale(value, scale);
    }

    private static double roundHalfUp0PosScale(final double value, final int scale) {
        final long val = (long) ((value + TOLERANCE) * pow10[scale + 2]);
        return val % 100 < 50 ? roundDown00PosScale(value, scale) : roundUp00PosScale(value, scale);
    }

    private static double roundUp0(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
    ...
    private static double roundUp00(final double value, final int scale) {
        return scale < 0 ? roundUp00NegScale(value, -scale) : roundUp00PosScale(value, scale);
    }

    private static double roundUp00NegScale(final double value, final int scale) {
        final long powten = pow10[scale];
        final double powtenNeg = pow10dNeg[scale];
        return ((double) (long) (value * powtenNeg + 1 - TOLERANCE)) * powten;
    }

    private static double roundUp00PosScale(final double value, final int scale) {
        final long powten = pow10[scale];
        final double powtenNeg = pow10dNeg[scale];
        return ((double) (long) (value * powten + 1 - TOLERANCE)) * powtenNeg;
    }

    private static double roundUp0NegScale(final double value, final int scale) {
        final long valueBits = Double.doubleToRawLongBits(value);
        final long signMask = valueBits & Numbers.SIGN_BIT_MASK;
        final double absValue = Double.longBitsToDouble(valueBits & ~Numbers.SIGN_BIT_MASK);
        return Double.longBitsToDouble(Double.doubleToRawLongBits(roundUp00NegScale(absValue, scale)) | signMask);
    ...
    private static boolean roundupDouble(final int firstDigitIndex, final char[] digits, final int nDigits) {
