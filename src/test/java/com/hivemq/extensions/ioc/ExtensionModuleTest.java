    ...
    public void setUp() throws Exception {
        ...
        injector = Guice.createInjector(new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(MqttConfigService.class).toInstance(mock(MqttConfigService.class));
                bind(RestrictionsConfigService.class).toInstance(mock(RestrictionsConfigService.class));
                bind(SecurityConfigService.class).toInstance(mock(SecurityConfigService.class));
