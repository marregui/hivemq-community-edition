...
import static com.hivemq.tk.seq.ConcurrentTest.publishEOE;
...
public class OneToOnePerformanceTest {
    public static void main(String[] args) throws BrokenBarrierException, InterruptedException {
        ...
        SingleConsumerSeq subSeq = new SingleConsumerSeq(cycle, null);
    ...
    static class BusyConsumer extends Thread {
        ...
        BusyConsumer(Seq sequence, RingQueue<Event> queue, CyclicBarrier barrier, CountDownLatch latch) {
